...
//import '../features/add_todo/data/datasources/todo_local_datasource.dart' as add_ds;
...
import '../features/show_todo/data/datasources/todo_local_datasource.dart' as add_ds;
...
class FeatureBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(() => AddTodoController(AddTodoUseCase(AddTodoRepositoryImpl(addLocal))));
    Get.lazyPut(() => ShowTodoController(GetTodosUseCase(ShowTodoRepositoryImpl(showLocal))));
  }
}
