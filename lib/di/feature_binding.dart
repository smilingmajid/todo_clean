...
class FeatureBinding extends Bindings {
  final HiveTranslateRepository translateRepo;

  FeatureBinding(this.translateRepo);
  ...
  void dependencies() {
    ...
    Get.lazyPut(
      () => TranslateController(
        getCurrentLanguage: GetCurrentLanguage(translateRepo),
        changeLanguageUseCase: ChangeLanguage(translateRepo),
      ),
      fenix: true,
    );
